...
class ReportingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ReportSpaceships = channel.unary_stream(
                '/spaceship.ReportingService/ReportSpaceships',
...
def add_ReportingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReportSpaceships': grpc.unary_stream_rpc_method_handler(
                    servicer.ReportSpaceships,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'spaceship.ReportingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('spaceship.ReportingService', rpc_method_handlers)
